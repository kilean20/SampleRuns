...
def differential_evolution(func, bounds, strategy='rand1bin', 
    ...
    strategy : str, optional
        The differential evolution strategy to use. Should be one of:
            ...
            - 'rand2bin'
            - 'rand1bin'
        The default is 'rand1bin'.
    maxtime : int, optional
        The maximum number of real times 
    ...
    solver = DifferentialEvolutionSolver(func, bounds, prev_result=prev_result,
                                         best_arg=best_arg, strategy=strategy, 
...
class DifferentialEvolutionSolver(object):
    ...
    def __init__(self, func, bounds, prev_result=OptimizeResult(), 
                 best_arg=None, strategy='rand1bin', maxiter=None, popsize=15,
                 tol=0.01, mutation=(0.5, 1), recombination=0.9, seed=None,
                 callback=None, disp=False, polish=True,
                 init='random',ncore=1,maxtime=None):
